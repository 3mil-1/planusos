...
$$
P = 2\left[\int_0^{\frac{3}{5}} \frac{2}{3}x\,dx + \int_{\frac{3}{5}}^{1}(1-x)\,dx\right] = \frac{6}{25} + \frac{4}{25} = \dfrac{2}{5}
$$
...
$$
F_X(\frac{1}{4}) = \frac{1}{2} - \frac{1}{16} = \dfrac{7}{16}
$$
...
$$
\mathrm{Var}(X) = \frac{1}{2} - \frac{1}{4} = \dfrac{1}{4}
$$
...
$$
\mathrm{Var}(X+Y) = \frac{23}{12} - \frac{25}{144} = \dfrac{251}{144} \approx 1{,}74
$$
...
$$
E(|X-Y|) = \frac{1}{4} + \frac{4}{6} = \dfrac{11}{12}
$$
