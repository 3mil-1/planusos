...
### a) Wzrost \(> 181\) cm
\[
P(X > 181) = P\left(Z > \frac{181-173}{6}\right) = P(Z > 1{,}33) \approx \boxed{0{,}091}
\]

### b) Wzrost między 167 a 180 cm
\[
P(167 < X < 180) = P\left(\frac{167-173}{6} < Z < \frac{180-173}{6}\right) = P(-1 < Z < 1{,}17) \approx \boxed{0{,}720}
\]
...
\[
x = \mu + z_{0{,}60} \cdot \sigma = 173 + 0{,}253 \cdot 6 \approx \boxed{174{,}5\ \text{cm}}
\]
