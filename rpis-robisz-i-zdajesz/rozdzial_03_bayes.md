...
\]
\[
= 0{,}6365 + 0{,}1552 + 0{,}1666 = \boxed{0{,}9583}
\]

### b) Z Chin **i** sprawny

\[
P(\text{Chiny} \cap \text{sprawny}) = 0{,}67 \cdot 0{,}95 = \boxed{0{,}6365}
\]

### c) Wyprodukowany w Chinach, **jeśli** ma wadę (Bayes)

\[
P(\text{Chiny}|\text{wada}) = \frac{0{,}67 \cdot 0{,}05}{1 - 0{,}9583} = \frac{0{,}0335}{0{,}0417} \approx \boxed{0{,}8034}
\]
