...
\[
\boxed{\text{Nie — tylko gdy } A \cap B = \emptyset}
\]
...
\[
\boxed{P(A \setminus B) = \dfrac{1}{8}}
\]
...
\[
P(X=6) = \left(\frac{1}{2}\right)^5 \cdot \frac{1}{2} = \left(\frac{1}{2}\right)^6 = \boxed{\dfrac{1}{64}}
\]

### b) Parzysta liczba rzutów
\[
P(X \text{ parzyste}) = \frac{1}{4} + \frac{1}{16} + \frac{1}{64} + \cdots = \frac{1/4}{1 - 1/4} = \boxed{\dfrac{1}{3}}
\]

### c) Liczba rzutów podzielna przez \(m\)
\[
P(X = km,\; k=1,2,\ldots) = \sum_{k=1}^{\infty}\left(\frac{1}{2}\right)^{km} = \frac{(1/2)^m}{1-(1/2)^m} = \boxed{\dfrac{1}{2^m - 1}}
\]
