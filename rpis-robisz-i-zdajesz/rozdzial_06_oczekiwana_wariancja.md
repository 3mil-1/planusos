...
### a) \(E(X)\)
\[
E(X) = (-1)\cdot\frac{1}{2} + 1\cdot\frac{1}{2} = \boxed{0}
\]
...
\]
\[
\mathrm{Var}(Y) = 2 - 0 = \boxed{2}
\]

### c) \(\mathrm{Var}(X + Y)\) przy nieskorelowaniu
\[
\mathrm{Var}(X) = E(X^2) = 1, \qquad \mathrm{Var}(X+Y) = 1 + 2 = \boxed{3}
\]
...
### a) \(E(X)\)
\[
E(X) = \int_{-1}^{0} 0{,}5x\,dx + \int_0^1 x(1-x)\,dx = -\frac{1}{4} + \frac{1}{6} = \boxed{-\dfrac{1}{12}}
\]
...
\]
\[
\mathrm{Var}(X) = \frac{1}{4} - \left(-\frac{1}{12}\right)^2 = \frac{1}{4} - \frac{1}{144} = \boxed{\dfrac{35}{144}}
\]
...
\]
\[
\boxed{E(e^{X-2}) = e^{-2}\left(e - \frac{3}{2} - \frac{1}{2e}\right) \approx 0{,}050}
\]
